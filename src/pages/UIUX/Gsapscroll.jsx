...
const GsapScroll = () => {
  ...
  return (
    <div className="h-screen">
     ...
     Lorem ipsum dolor sit amet, consectetur adipisicing elit. Laborum ullam ex quibusdam explicabo, delectus unde quidem dolorum corporis. Minus rerum nam velit culpa numquam? Voluptatibus saepe reprehenderit porro ullam explicabo?
    </div>
  );
};
